...
public partial class NavMenu
{
    ...
    private bool _canViewServiceAccounts;
    ...
    private async Task GetPermissions()
    {
        ...
        _canViewServiceAccounts = await AuthorizationService.UserHasPermission(currentUser, PermissionConstants.ServiceAccounts.View);
    }
}